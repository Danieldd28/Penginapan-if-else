 ...
 */
public class PenginapanNgawi {
    public static void main(String[] args) {
        Scanner input = new Scanner (System.in);
         System.out.println("masukan kamar :     (duku/jeruk/alpukat/jambu/durian/melon/belimbing/mangga/kedondong/barrack)");
        String kamar = input.nextLine();
        System.out.println("masukan hari :        (Weekday/Weekend/Holiday)");
        String hari = input.nextLine();
        
        System.out.println("masukan jumlah kuota :");
        ...
        System.out.println("Harga kamar " + kamar + " dengan jumlah kuota " + orang + " di " + hari + " = " + harga);
